...
public class TagListaPrioridad implements Tag {
...
//		System.out.println("doStartTag");
        ...
        try {
            ComboboxDAO objP = objDAOFactory.getComboboxDAO();
            ...
            Logger.getLogger(TagListaPrioridad.class.getName()).log(Level.SEVERE, null, ex);
        }
