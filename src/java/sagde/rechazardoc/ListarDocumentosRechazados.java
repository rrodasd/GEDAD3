...
public class ListarDocumentosRechazados extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (objbean == null) {
            ...
            getServletContext().getRequestDispatcher("/gedad/rechazardoc/I_Rechazados.jsp").forward(request, response);
        }
    }
