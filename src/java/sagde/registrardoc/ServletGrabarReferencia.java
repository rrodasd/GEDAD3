...
public class ServletGrabarReferencia extends HttpServlet{
  ...
  String accion = request.getParameter("accion").trim();  
    ...
    */
    public boolean Grabar_Referencia(HttpServletRequest req,HttpServletResponse response) {
       ...
       String cbx_Clasificacion = req.getParameter("cbx_Clasificacion"); 
       String cbx_Prioridad = req.getParameter("cbx_Prioridad"); 
        String perido_orig = req.getParameter("perido_orig"); 
         String cod_int_orig = req.getParameter("cod_int_orig"); 
	...
	String usuario = beanusuario.getVUSUARIO_CODIGO().trim();
        ...
        System.out.println("cbx_Clasificacion  : " + cbx_Clasificacion);
        ...
        objBeanRegDocumento.setCDOCUMENTO_CLASIFICACION(cbx_Clasificacion);
        ...
        objBeanRegDocumento.setCDOCUMENTO_PERIODO_ORIG(perido_orig);
        objBeanRegDocumento.setCDOCUMENTO_COD_DOC_INT_ORIG(cod_int_orig);

       // objBeanRegDocumento.setVDISTRIBUCION_NOM_FILE(filename);    
       
       String codigoInterno=objDocumentoDAO.insertarDocRegistrado_REF(objBeanRegDocumento);    
            ...
            if( isMultipartForm ){                
                ...
                for (FileItem item : items) {  
                    ...
                    //(09)Guardar en la Bd el token y tamb en la base de datos
                        ...
                        System.out.println("cbo_Tipo_Organizacion  : " + cbo_Tipo_Organizacion);
                        System.out.println("cod_org_usuario  : " + String.format("%1$-30s", cod_org_usuario)+ "---");
                           ...
                           // objBeanAN.setBANEXO_IMAGEN_ARCHIVO(streamEntrada1);
                            ...
                            pcs.setString(6, String.format("%1$-30s", cod_org_usuario));
                            pcs.executeUpdate();
                            cnx.commit();
                    }
