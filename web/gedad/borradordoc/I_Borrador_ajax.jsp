 ...
 */ else if (reporte.equals("REV_02")) {
    ...
    if (clase.equals("0001")) {
        ...
        BeanRevisarDocumento objBeanRD = objRD.obtenerDocXBorrador(periodo, codint, objbean.getVUSUARIO_CODIGO());
        if(objBeanRD.getVDISTRIBUCION_GRADO()==null){
           objBeanRD.setVDISTRIBUCION_GRADO(""); 
        }
        if(objBeanRD.getVDISTRIBUCION_CARGO()==null){
           objBeanRD.setVDISTRIBUCION_CARGO(""); 
        }
        if(objBeanRD.getVDOCUMENTO_ASUNTO()==null){
           objBeanRD.setVDOCUMENTO_ASUNTO(""); 
        }
...
<table width="100%" border="0">
    ...
    <tr>
        ...
        <td width="20">&nbsp;</td>
        <td width="500">&nbsp;</td>
        <td><div  class="EstiloOF" align="center">Dios guarde a Ud.</div></td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        <td>&nbsp;</td>
